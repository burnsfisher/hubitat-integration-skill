...
URL = "https://github.com/burnsfisher/hubitat-integration-skill"
SKILL_CLAZZ = "HubitatIntegration"  # needs to match __init__.py class name
PYPI_NAME = "skill-hubitat-integration"  # pip install PYPI_NAME
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="A Mycroft/OVOS skill to integrate with Hubitat",
    ...
    keywords="ovos mycroft skill voice assistant hubitat",
